...
class EnvPlaneDispatcher(object):
    ...
    def program_list_changed(self):
        ...
        gobject.idle_add(self._opensand_view.on_program_list_changed,
                         programs, priority=gobject.PRIORITY_HIGH_IDLE+20)

    def new_probe_value(self, probe, time, value):
        """
        The controller reported a new probe value
        """
        gobject.idle_add(self._opensand_view.on_new_probe_value,
                         probe, time, value,
    ...
    def new_log(self, program, name, level, message):
        ...
        gobject.idle_add(self._opensand_view.on_new_program_log,
