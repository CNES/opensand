...
def rtnl_link_set_type(*args):
  return _capi.rtnl_link_set_type(*args)
rtnl_link_set_type = _capi.rtnl_link_set_type

def rtnl_link_get_type(*args):
  return _capi.rtnl_link_get_type(*args)
rtnl_link_get_type = _capi.rtnl_link_get_type

def rtnl_route_alloc():
  return _capi.rtnl_route_alloc()
rtnl_route_alloc = _capi.rtnl_route_alloc

def rtnl_route_add(*args):
  return _capi.rtnl_route_add(*args)
rtnl_route_add = _capi.rtnl_route_add

def rtnl_route_delete(*args):
  return _capi.rtnl_route_delete(*args)
rtnl_route_delete = _capi.rtnl_route_delete

def rtnl_route_set_dst(*args):
  return _capi.rtnl_route_set_dst(*args)
rtnl_route_set_dst = _capi.rtnl_route_set_dst

def rtnl_route_get_dst(*args):
  return _capi.rtnl_route_get_dst(*args)
rtnl_route_get_dst = _capi.rtnl_route_get_dst

def rtnl_route_set_src(*args):
  return _capi.rtnl_route_set_src(*args)
rtnl_route_set_src = _capi.rtnl_route_set_src

def rtnl_route_get_src(*args):
  return _capi.rtnl_route_get_src(*args)
rtnl_route_get_src = _capi.rtnl_route_get_src

def rtnl_route_add_nexthop(*args):
  return _capi.rtnl_route_add_nexthop(*args)
rtnl_route_add_nexthop = _capi.rtnl_route_add_nexthop

def rtnl_route_remove_nexthop(*args):
  return _capi.rtnl_route_remove_nexthop(*args)
rtnl_route_remove_nexthop = _capi.rtnl_route_remove_nexthop

def rtnl_route_nh_alloc():
  return _capi.rtnl_route_nh_alloc()
rtnl_route_nh_alloc = _capi.rtnl_route_nh_alloc

def rtnl_route_nh_clone(*args):
  return _capi.rtnl_route_nh_clone(*args)
rtnl_route_nh_clone = _capi.rtnl_route_nh_clone

def rtnl_route_nh_free(*args):
  return _capi.rtnl_route_nh_free(*args)
rtnl_route_nh_free = _capi.rtnl_route_nh_free

def rtnl_route_nh_compare(*args):
  return _capi.rtnl_route_nh_compare(*args)
rtnl_route_nh_compare = _capi.rtnl_route_nh_compare

def rtnl_route_nh_dump(*args):
  return _capi.rtnl_route_nh_dump(*args)
rtnl_route_nh_dump = _capi.rtnl_route_nh_dump

def rtnl_route_nh_set_weight(*args):
  return _capi.rtnl_route_nh_set_weight(*args)
rtnl_route_nh_set_weight = _capi.rtnl_route_nh_set_weight

def rtnl_route_nh_get_weight(*args):
  return _capi.rtnl_route_nh_get_weight(*args)
rtnl_route_nh_get_weight = _capi.rtnl_route_nh_get_weight

def rtnl_route_nh_set_ifindex(*args):
  return _capi.rtnl_route_nh_set_ifindex(*args)
rtnl_route_nh_set_ifindex = _capi.rtnl_route_nh_set_ifindex

def rtnl_route_nh_get_ifindex(*args):
  return _capi.rtnl_route_nh_get_ifindex(*args)
rtnl_route_nh_get_ifindex = _capi.rtnl_route_nh_get_ifindex

def rtnl_route_nh_set_gateway(*args):
  return _capi.rtnl_route_nh_set_gateway(*args)
rtnl_route_nh_set_gateway = _capi.rtnl_route_nh_set_gateway

def rtnl_route_nh_get_gateway(*args):
  return _capi.rtnl_route_nh_get_gateway(*args)
rtnl_route_nh_get_gateway = _capi.rtnl_route_nh_get_gateway

def rtnl_route_nh_set_flags(*args):
  return _capi.rtnl_route_nh_set_flags(*args)
rtnl_route_nh_set_flags = _capi.rtnl_route_nh_set_flags

def rtnl_route_nh_unset_flags(*args):
  return _capi.rtnl_route_nh_unset_flags(*args)
rtnl_route_nh_unset_flags = _capi.rtnl_route_nh_unset_flags

def rtnl_route_nh_get_flags(*args):
  return _capi.rtnl_route_nh_get_flags(*args)
rtnl_route_nh_get_flags = _capi.rtnl_route_nh_get_flags

def rtnl_route_nh_set_realms(*args):
  return _capi.rtnl_route_nh_set_realms(*args)
rtnl_route_nh_set_realms = _capi.rtnl_route_nh_set_realms

def rtnl_route_nh_get_realms(*args):
  return _capi.rtnl_route_nh_get_realms(*args)
rtnl_route_nh_get_realms = _capi.rtnl_route_nh_get_realms

def rtnl_route_nh_flags2str(*args):
  return _capi.rtnl_route_nh_flags2str(*args)
rtnl_route_nh_flags2str = _capi.rtnl_route_nh_flags2str

def rtnl_route_nh_str2flags(*args):
  return _capi.rtnl_route_nh_str2flags(*args)
rtnl_route_nh_str2flags = _capi.rtnl_route_nh_str2flags
