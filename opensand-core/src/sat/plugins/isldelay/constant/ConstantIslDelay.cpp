...
#include "ConstantIslDelay.h"
#include "OpenSandModelConf.h"

#include <opensand_output/Output.h>


std::string ConstantIslDelay::config_path = "";


ConstantIslDelay::ConstantIslDelay():
		IslDelayPlugin(),
		is_init(false)
{
}
...
void ConstantIslDelay::generateConfiguration(const std::string &parent_path,
                                             ...
                                             const std::string& plugin_name)
{
	...
	ConstantIslDelay::config_path = parent_path;
...
bool ConstantIslDelay::updateIslDelay()
{
...
bool ConstantIslDelay::getMaxDelay(time_ms_t &delay) const
{
	if(!this->is_init)
	{
		return false;
