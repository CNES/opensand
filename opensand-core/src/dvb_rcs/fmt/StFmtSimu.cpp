 ...
 */
unsigned int StFmtSimu::getCurrentModcodId() const
{
 ...
 */
void StFmtSimu::updateModcodId(unsigned int new_id)
{
	this->previous_modcod_id = this->current_modcod_id;
 ...
 */
unsigned int StFmtSimu::getPreviousModcodId() const
{
 ...
 */
unsigned int StFmtSimu::getCurrentDraSchemeId() const
{
 ...
 */
void StFmtSimu::updateDraSchemeId(unsigned int new_id)
{
