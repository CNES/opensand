...
/**
 * @file     UplinkScheduling.cpp
 * @brief    The scheduling functions for MAC FIFOs with DVB-RCS uplink
...
bool UplinkSchedulingRcs::allocateDvbRcsFrame(DvbRcsFrame **incomplete_dvb_frame)
{
