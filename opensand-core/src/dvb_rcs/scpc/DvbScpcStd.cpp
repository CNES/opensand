...
/**
 * @file DvbScpcStd.cpp
 * @brief SCPC Transmission Standard
...
DvbScpcStd::~DvbScpcStd()
{
}


// TODO factorize with DVB-RCS function ?
bool DvbScpcStd::onRcvFrame(DvbFrame *dvb_frame,
                            ...
                            NetBurst **burst)
{
	...
	*burst = NULL;
	...
	//TODO: The GW ModCod is fixed but must be afaptive (Terminals need to know GW ModCod)
